...
export default {
  ...
  resolve: {
    ...
    alias: {
      ...
      Component: path.resolve(config.scripts.source, 'Component.js'),
      Config: path.resolve(config.scripts.source, 'Config.js'),
      Plugin: path.resolve(config.scripts.source, 'Plugin.js'),
