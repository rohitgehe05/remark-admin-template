...
<div class="slidePanel-inner">
  <section class="slidePanel-inner-section">
    ...
    <div class="task-section subtasks">
      <label><i class="icon wb-list-bulleted mr-10"></i>Subtasks</label>
    ...
    <div class="task-section attachments">
      <label><i class="icon wb-paperclip mr-10"></i>Attachments | <a href="#">Download All</a></label>
      <ul class="list-group attachments-list"></ul>
    </div>
  </section>
  <section class="slidePanel-inner-section">
    <div class="comments">
      <label><i class="icon wb-chat-group mr-10"></i>Comments</label>
