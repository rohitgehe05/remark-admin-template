      ...
      var options = _jquery2.default.extend(true, {}, defaults, {
        initComplete: function initComplete() {
          this.api().columns().every(function () {
            var column = this;
            var select = (0, _jquery2.default)('<select class="form-control js-full"><option value=""></option></select>').appendTo((0, _jquery2.default)(column.footer()).empty()).on('change', function () {
